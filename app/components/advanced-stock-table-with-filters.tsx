...
export function AdvancedStockTableWithFilters({
  data,
  columns,
  loading,
  ...
  const processedData = useMemo(() => {
    ...
    // ST股票过滤
    if (filterST) {
      filteredData = filteredData.filter(item => !item.name.includes('ST'))
    }
    ...
    return filteredData
  }, [data, searchTerm, sortConfigs, filterST, isHydrated, filtersHydrated, applyFilters])
  ...
  return (
    <Paper elevation={2} sx={{ width: '100%', overflow: 'hidden' }}>
      ...
      <FilterPanel
        ...
        onMultiSelectFilterChange={setMultiSelectFilter}
        onResetFilters={resetFilters}
        getAvailableOptions={getAvailableOptions}
        isHydrated={isHydrated && filtersHydrated}
      />
